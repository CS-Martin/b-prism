    ...
    return (
        <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
            ...
            <Card>
                ...
                <CardContent>
                    <div className='text-2xl font-bold'>{rescuePosts.filter((post) => !post.isRescued).length}</div>
            ...
            <Card>
                ...
                <CardContent>
                    <div className='text-2xl font-bold'>{rescuePosts.reduce((sum, post) => sum + Number(post.number_of_people_affected), 0)}</div>
