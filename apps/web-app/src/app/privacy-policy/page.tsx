...
export default function PrivacyPolicyPage() {
    return (
        <main className='min-h-screen'>
            ...
            <div className='container max-w-6xl py-16 mx-auto mt-[5%]'>
                <HaribonPolicy />
                <MessengerBotPolicy />
                    ...
                    <CardDescription className='px-5'>
                        <div className='flex flex-col gap-3 p-3 border rounded'>
                            ...
                            <div className='flex flex-row items-center gap-2'>
                                ...
                                <p className='font-semibold text-black'>Ateneo de Naga University, Bagumbayan Sur, Naga City</p>
                            </div>
                        </div>
                    </CardDescription>
                </Card>
